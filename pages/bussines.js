...
export default function Bussines({ article, trending }) {
  return (
    <div>
      <Layout title="Bussines">
        <h1 className="text-2xl uppercase font-bold opacity-50 my-10 ml-24">
          See what's happening around the world of bussines
        </h1>
        <div className="flex">
...
export async function getServerSideProps() {
  const article = await Client().query(
    Prismic.Predicates.at("document.tags", ["bussines"])
  );
